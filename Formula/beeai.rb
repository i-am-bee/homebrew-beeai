class Beeai < Formula
  ...
  url "https://files.pythonhosted.org/packages/de/1b/29dc5c7fdbfa52b842d40295948a0908f68c586e062ddf5a91bfad152c84/beeai_cli-0.0.6.tar.gz"
  sha256 "161cd0e91c8e9945501265bc0b939e83fe7209a4f50179e69a6669d0e5e3cefe"
  license "Apache-2.0"

  bottle do
    root_url "https://github.com/i-am-bee/homebrew-beeai/releases/download/beeai-0.0.6"
    sha256 cellar: :any,                 arm64_sequoia: "91c1c14e00c40258515c0acff5977ead8a1b4ff88cd2a006c8f758bfb2e06e47"
    sha256 cellar: :any,                 arm64_sonoma:  "0c63642f103e88718d2e14a1ba04a780527eda6d97c9e632685292f999a00ae1"
    sha256 cellar: :any,                 ventura:       "ccedcf9d548d120a60ff9b2645b5ee5b1bc6e70b7cd0eb2ba260f69287f5d090"
    sha256 cellar: :any_skip_relocation, x86_64_linux:  "1b5276717b78e767064a3d2668471911ba2013c1ea64db2b6db2919b9332da6f"
  end
  ...
  resource "beeai-server" do
    url "https://files.pythonhosted.org/packages/65/98/27772ac659f080705ee434d98f8c5991845ce2902a06934c24882c8f6025/beeai_server-0.0.5.tar.gz"
    sha256 "c1e1c124cf7f7b15562ed0d59e7d830d7f732ad4afa507f020930d9a3257c135"
  end
